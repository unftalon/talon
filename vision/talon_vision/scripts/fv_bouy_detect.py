...
#
# fv_bouy_detect.py
# Forward Vision buoy detector
# 
# This node will subscribe to filtered camera images, detect the bouy, and send information about its location
#
# TODO: 
#
...
# ALL of the below code has been forked from fv_qgate_detect.py on 10/17/16 and is awaiting to be converted for use
# on detecting bouys
...
class fv_bouy_detect:

	def __init__(self):
		# set up publishers and subscribers
		self.image_pub = rospy.Publisher("/vision/fwd/bouy_mask", Image, queue_size=1)
	...
	def callback(self, data):
		...
		# for now is "green" for whatever reason. will change later
...
def main(args):
	fqd = fv_bouy_detect()
	rospy.init_node('fv_bouy_detect', anonymous=True)
